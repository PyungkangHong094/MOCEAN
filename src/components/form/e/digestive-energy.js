...
const DigestiveEnergyForm = ({ standardValue, onInput,ogData }) => {
  ...
  return (
    <InputForm title={"Digestive energy"} defaultValue={ogData} onChange={onChange}>
      {status != null && (
...
export default DigestiveEnergyForm;
